      ...
      <div className="relative w-full max-w-2xl h-full md:h-auto">
        <div className="relative bg-white rounded-lg shadow ">
          ...
          <div className="px-10 text-md font-bold text-gray-500">
            ...
            iusto ullam reiciendis distinctio nihil sint facere aut asperiores
            provident culpa dicta nemo, ea qui odio? Quas atque quasi dolorum
            ducimus.
          </div>
          ...
          <div className="flex items-center p-6 space-x-2 rounded-b justify-center ">
            ...
            >
              {modalData[language].button[1].text}
            </button>
            <a
              onClick={() => dispatch(uiActions.toggleModal(false))}
              href="/thankyou"
            ...
            >
              {modalData[language].button[0].text}
            </a>
          </div>
        </div>
      </div>
